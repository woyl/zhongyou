...
import com.zhongyou.meet.mobile.utils.UiUtil;

/**
 * @author luopan@centerm.com
 * @date 2020-02-27 15:10.
 */
public class FreeView extends TextView {
	...
	public FreeView(Context context, @Nullable AttributeSet attrs) {
		super(context, attrs);
	}

	public FreeView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
		super(context, attrs, defStyleAttr);
	}

	@RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
	public FreeView(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
