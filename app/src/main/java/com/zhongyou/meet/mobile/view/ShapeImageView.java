...
public class ShapeImageView extends ImageView {
	...
	public void setImageResource(int resId) {
		...
		mBitmap = com.zhongyou.meet.mobile.view.ImageUtils.getBitmapFromDrawable(getDrawable());
		setupBitmapShader();
	}
	...
	public void setImageDrawable(Drawable drawable) {
		...
		mBitmap = com.zhongyou.meet.mobile.view.ImageUtils.getBitmapFromDrawable(drawable);
		setupBitmapShader();
	}
