...
public class FragmentLifecycleCallbacksImpl extends FragmentManager.FragmentLifecycleCallbacks {
    ...
    public void onFragmentViewCreated(@NotNull FragmentManager fm, Fragment f, @NotNull View v, Bundle savedInstanceState) {
        ...
        if (v.findViewById(R.id.refreshLayout)!=null){
            if (v.findViewById(R.id.refreshLayout) instanceof SmartRefreshLayout){
                SmartRefreshLayout refreshLayout=v.findViewById(R.id.refreshLayout);
                if (f.getActivity()!=null){
                    refreshLayout.setRefreshHeader(new MaterialHeader(f.getActivity()));
                }
            }
        }
    }
