 ...
 */
@ActivityScope
public class MakerCourseMeetDetailModel extends BaseModel implements MakerCourseMeetDetailContract.Model {
	@Inject
	Gson mGson;
	@Inject
	...
	@Inject
	public MakerCourseMeetDetailModel(IRepositoryManager repositoryManager) {
