...
class NoAgreeLoginDialogFragment(appCompatActivity: AppCompatActivity?) :BaseDialogFragment(true,Gravity.CENTER) {
    ...
    override fun initViews() {
        view =  inflater.inflate(R.layout.dialog_no_laucher_login,null)
...
//        val colorSpan = ForegroundColorSpan(resources.getColor(R.color.c3A8CE8))
        ...
        spannableStringBuilder.setSpan(clickableSpan,10,15, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE)
