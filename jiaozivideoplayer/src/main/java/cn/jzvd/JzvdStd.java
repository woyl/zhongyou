...
public class JzvdStd extends Jzvd {
	...
	@Override
	public void showLoadingView(boolean ishow) {
		loadingProgressBar.setVisibility(ishow ? VISIBLE : INVISIBLE);
	}
	...
	public void onClickUiToggle() {//这是事件
		...
		} else if (state == STATE_PLAYING || state == Jzvd.STATE_LOADING) {
			if (bottomContainer.getVisibility() == View.VISIBLE) {
				changeUiToPlayingClear();
			} else {
	...
	public void onProgress(int progress, long position, long duration) {
		...
		if (mOnPlayTimeChange != null) {
			mOnPlayTimeChange.onPlayTimeChange(progress, position, duration);
		}
	}

	public OnPlayTimeChange mOnPlayTimeChange;

	public interface OnPlayTimeChange {
		void onPlayTimeChange(int progress, long position, long duration);
	}

	public void setOnPlayTimeChangeListener(OnPlayTimeChange onPlayTimeChange) {
		mOnPlayTimeChange = onPlayTimeChange;
	}
	...
	public void changeUiToNormal() {
		Log.e(TAG, "changeUiToNormal: " + screen);
		switch (screen) {
			case SCREEN_NORMAL:
	...
	public void changeUiToPreparing() {
		Log.e(TAG, "changeUiToPreparing: " + screen);
		switch (screen) {
			case SCREEN_NORMAL:
			case SCREEN_FULLSCREEN:
	...
	public void changeUiToPlayingShow() {
		Log.e(TAG, "changeUiToPlayingShow: " + screen);
		switch (screen) {
			case SCREEN_NORMAL:
	...
	public void changeUiToPlayingClear() {
		Log.e(TAG, "changeUiToPlayingClear: " + screen);
		switch (screen) {
			case SCREEN_NORMAL:
				setAllControlsVisiblity(View.INVISIBLE, View.INVISIBLE, View.INVISIBLE,
	...
	public void changeUiToPauseShow() {
		Log.e(TAG, "changeUiToPauseShow: " + screen);
		switch (screen) {
			case SCREEN_NORMAL:
				setAllControlsVisiblity(View.VISIBLE, View.VISIBLE, View.VISIBLE,
						View.INVISIBLE, View.INVISIBLE, View.INVISIBLE, View.INVISIBLE);
	...
	public OnBackPressListener mOnBackPressListener;
	...
	public interface onStartVideo {
		void onStart(boolean isStart);
	}

	public onStartVideo startVideo;
	public void setStartVideo(onStartVideo startVideoClick) {
		startVideo = startVideoClick;
	}
}
