...
import io.agora.whiteboard.netless.manager.BusinessException;
import io.agora.whiteboard.netless.manager.ResponseBody;
...
public class RetrofitManager {
    ...
    public static class Callback<T extends ResponseBody> implements retrofit2.Callback<T> {
        private int code;
        private io.agora.whiteboard.netless.Callback<T> callback;

        public Callback(int code, @NonNull io.agora.whiteboard.netless.Callback<T> callback) {
            this.code = code;
