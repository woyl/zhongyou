			...
			mAlertDialog = new com.adorkable.iosdialog.AlertDialog(BaseActivity.this)
					...
					.setPositiveButton("退出", new View.OnClickListener() {
						...
						public void onClick(View v) {
							...
							intent.setClassName("com.zhongyou.meet.mobile", "com.zhongyou.meet.mobile.wxapi.WXEntryActivity");
							intent.putExtra("isBadToken", true);
							intent.setAction("com.zhongyou.meeting.mobile.wxentryactivity");
