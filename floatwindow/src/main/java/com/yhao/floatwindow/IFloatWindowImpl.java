...
public class IFloatWindowImpl extends IFloatWindow {
	...
	private int mSlop;
	public static final String KEY_FLOATWINDOW_CLICK = "com.zhongyou.meet.mobile.pullupactivity";
						...
						switch (event.getAction()) {
							...
							case MotionEvent.ACTION_UP:
								...
								if (!mClick) {
									...
									intent.setAction(KEY_FLOATWINDOW_CLICK);
									mB.mApplicationContext.sendBroadcast(intent);
								}
								switch (mB.mMoveType) {
									case MoveType.slide:
